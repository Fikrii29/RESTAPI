...
router.get('/download/mediafire', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)){
    fetch(encodeURI(`https://api.botcahx.live/api/dowloader/mediafire?url=${url}&apikey=Fikrii`))
    .then(response => response.json())
        .then(hasil => {
...
router.get('/stalk/github', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)){
    fetch(encodeURI(`https://api.botcahx.live/api/stalk/github?username=${username}&apikey=Fikrii`))
    .then(response => response.json())
        .then(hasil => {
...
router.get('/stalk/ig', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)){
    fetch(encodeURI(`https://api.botcahx.live/api/stalk/ig?username=${username}&apikey=Fikrii`))
    .then(response => response.json())
        .then(hasil => {
...
router.get('/download/ytmp32', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)){
    fetch(encodeURI(`https://api.botcahx.live/api/dowloader/yt?url=${url}&apikey=Fikrii`))
    .then(response => response.json())
        .then(hasil => {
...
router.get('/downloader/xnxx', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)){
    fetch(encodeURI(`https://api.botcahx.live/api/download/xnxxdl?url=${url}&apikey=Fikrii`))
    .then(response => response.json())
        .then(hasil => {
...
router.get('/downloader/twittervid', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)){
    fetch(encodeURI(`https://api.botcahx.live/api/dowloader/twitter?url=${url}&apikey=Fikrii`))
    .then(response => response.json())
        .then(hasil => {
...
router.get('/downloader/xvideo', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)){
    fetch(encodeURI(`https://api.botcahx.live/api/download/xvideosdl?url=${url}&apikey=Fikrii`))
    .then(response => response.json())
        .then(hasil => {
...
router.get('/downloader/pinterest', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)){
    fetch(encodeURI(`https://api.botcahx.live/api/download/pinterest?url=${url}&apikey=Fikrii`))
    .then(response => response.json())
        .then(hasil => {
...
router.get('/download/tiktok3', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)){
    fetch(encodeURI(`https://api.botcahx.live/api/dowloader/tiktok?url=${url}&apikey=Fikrii`))
    .then(response => response.json())
        .then(hasil => {
...
router.get('/downloader/facebook2', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)){
    fetch(encodeURI(`https://api.botcahx.live/api/dowloader/fbdown2?url=${url}&apikey=Fikrii`))
    .then(response => response.json())
        .then(hasil => {
...
router.get('/stalker/tiktok', async (req, res, next) => {
	...
	let ttstalk = await fetchJson(`https://api.botcahx.live/api/stalk/tt?username=${username}&apikey=Fikrii`)
...
router.get('/maker/pubglogo', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = 'https://kadeskuy.cyclic.app/api/photooxy/pubg-mobile?text1='+ text1 + '&text2' +'&apikey=Alphabot'
  data = await fetch(hasil).then(v => v.buffer())
...
router.get('/maker/naruto', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = 'https://kadeskuy.cyclic.app/api/photooxy/naruto?text='+ text +'&apikey=Alphabot' 
  data = await fetch(hasil).then(v => v.buffer())
...
router.get('/downloader/facebook2', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)){
    fetch(encodeURI(`https://api.botcahx.live/api/dowloader/fbdown?url=${url}&apikey=Fikrii`))
    .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
